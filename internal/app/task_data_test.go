...
func TestParseOTATaskData(t *testing.T) {
	...
	t.Run("invalid json", func(t *testing.T) {
		...
		if !strings.Contains(err.Error(), "некорректный JSON в ota_task.taskData") {
...
func TestPrintTaskOverviewShowsDownloadFailInfo(t *testing.T) {
	...
	if !strings.Contains(output, "Информация об ошибке загрузки: network timeout") {
...
func TestPrintTaskOverviewAllowsFlashFailureCaseWithoutFlashState(t *testing.T) {
	...
	if strings.Contains(output, "Причина ошибки прошивки") {
