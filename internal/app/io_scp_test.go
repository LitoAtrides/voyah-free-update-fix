...
func TestReadSCPHeader(t *testing.T) {
	...
	t.Run("invalid size", func(t *testing.T) {
		...
		if !strings.Contains(err.Error(), "некорректный размер файла scp") {
			t.Fatalf("unexpected error: %v", err)
		}
	})
	...
	t.Run("negative size", func(t *testing.T) {
		...
		if !strings.Contains(err.Error(), "некорректный отрицательный размер файла scp") {
			t.Fatalf("unexpected error: %v", err)
		}
	})
	...
	t.Run("invalid mode", func(t *testing.T) {
		...
		if !strings.Contains(err.Error(), "некорректный режим файла scp") {
			t.Fatalf("unexpected error: %v", err)
		}
	})
	...
	t.Run("extra fields", func(t *testing.T) {
		...
		if !strings.Contains(err.Error(), "неожиданный формат scp-заголовка") {
			t.Fatalf("unexpected error: %v", err)
		}
	})
	...
	t.Run("unexpected prefix", func(t *testing.T) {
		...
		if !strings.Contains(err.Error(), "неожиданный префикс scp-заголовка") {
			t.Fatalf("unexpected error: %v", err)
		}
	})
}
...
func TestReadSCPAck(t *testing.T) {
	...
	t.Run("error without message", func(t *testing.T) {
		...
		if !strings.Contains(err.Error(), "неизвестная ошибка scp") {
			t.Fatalf("unexpected error: %v", err)
		}
	})
	...
	t.Run("unexpected ack", func(t *testing.T) {
		...
		if !strings.Contains(err.Error(), "неожиданное значение scp ack") {
			t.Fatalf("unexpected error: %v", err)
		}
	})
}
